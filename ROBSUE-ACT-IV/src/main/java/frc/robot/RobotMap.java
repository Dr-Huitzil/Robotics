...
public class RobotMap {
  ...
  public static int elevatorPort1 = 6; //new motor for the elevator; Killer Queen
  public static int elevatorPort2 = 10; //second elevator: updog
  ...
  public static int spam3Port = 9; //motor controller for the color wheel; (IM TRUSTING YOU TO GIVE IT A GOOD NAME); Over The Rainbow
  public static int spam4Port = 11; //motor controller for shooter
  ...
  // public static int sideTrigger = 2;
